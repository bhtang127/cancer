...
/*-----------------------------------------------
              @(target):= _fast_mutation.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__fast_mutation

#else
#  define SWIG_init    init_fast_mutation

#endif
#define SWIG_name    "_fast_mutation"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_inplace_poisson_mutation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:inplace_poisson_mutation",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  {
  ...
  }
  {
    ...
    array4 = obj_to_array_contiguous_allow_conversion(obj1, NPY_UINT,
      &is_new_object4);
  ...
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "inplace_poisson_mutation" "', argument " "6"" of type '" "int""'");
  } 
  arg6 = (int)(val6);
  ecode7 = SWIG_AsVal_int(obj3, &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "inplace_poisson_mutation" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = (int)(val7);
  ecode8 = SWIG_AsVal_double(obj4, &val8);
  if (!SWIG_IsOK(ecode8)) {
    SWIG_exception_fail(SWIG_ArgError(ecode8), "in method '" "inplace_poisson_mutation" "', argument " "8"" of type '" "double""'");
  } 
  arg8 = (double)(val8);
  inplace_poisson_mutation(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
SWIGINTERN PyObject *_wrap_inplace_expand(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = (int *) 0 ;
  int arg2 ;
  int *arg3 = (int *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:inplace_expand",&obj0,&obj1)) SWIG_fail;
  {
  ...
  inplace_expand(arg1,arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  {
